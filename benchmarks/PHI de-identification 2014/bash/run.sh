...
python NER_sentence.py -c "/home/ehsu/David_projects/LLM-IE_benchmark/benchmarks/PHI de-identification 2014/configs/Meta-Llama-3.3-70B-Instruct_float16_ner_sentence.yaml"