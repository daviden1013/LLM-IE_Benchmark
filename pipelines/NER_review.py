...
from llm_ie.extractors import ReviewFrameExtractor
...
def main():
    ...
    logging.info(f"Loading review prmopt template from {config['review_prompt_template']}")
    with open(config['review_prompt_template'], 'r') as f:
    ...
    extractor = ReviewFrameExtractor(inference_engine=engine,
