...
def main():
    ...
    extractor = SentenceCoTFrameExtractor(inference_engine=engine,
    ...
    for ie in loop:
        ...
        frames = extractor.extract_frames(text_content=ie['text'], entity_key="entity_text", multi_turn=False, stream=True)
